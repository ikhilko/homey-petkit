...
const ACTIONS_MAP = {
  ...
  [DeviceCommand.UPDATE_SETTING]: {
    ...
    getParams: (device, setting) => ({ id: device.deviceNfo.deviceId, ...setting }),
  ...
  [LitterCommand.RESET_N50_DEODORIZER]: {
    ...
    getParams: (device) => ({ id: device.deviceNfo.deviceId }),
  ...
  [PetCommand.PET_UPDATE_SETTING]: {
    endpoint: 'updatePet',
    getParams: (device, setting) => ({ petId: device.deviceNfo.deviceId, ...setting }),
  ...
  [DeviceAction.START]: {
    endpoint: 'controlDevice',
    getParams: (device, setting) => ({ id: device.deviceNfo.deviceId, cmd: setting?.cmd || LBCommand.CLEANING }),
    supportedDevices: [...DEVICES_LITTER_BOX, ...DEVICES_PURIFIER]
  },
  [DeviceAction.STOP]: {
    endpoint: 'controlDevice',
    getParams: (device) => ({ id: device.deviceNfo.deviceId, cmd: LBCommand.RESETTING }),
    supportedDevices: DEVICES_LITTER_BOX
  },
  [DeviceAction.CONTINUE]: {
    endpoint: 'controlDevice',
    getParams: (device) => ({ id: device.deviceNfo.deviceId, cmd: 'continue' }),
    supportedDevices: [...DEVICES_LITTER_BOX, ...DEVICES_PURIFIER]
  },
  [DeviceAction.END]: {
    endpoint: 'controlDevice',
    getParams: (device) => ({ id: device.deviceNfo.deviceId, cmd: 'end' }),
    supportedDevices: [...DEVICES_LITTER_BOX, ...DEVICES_PURIFIER]
  },
  [DeviceAction.POWER]: {
    endpoint: 'controlDevice',
    getParams: (device, setting) => ({ id: device.deviceNfo.deviceId, cmd: setting?.power ? 'on' : 'off' }),
    supportedDevices: DEVICES_PURIFIER
  },
  [DeviceAction.MODE]: {
    endpoint: 'controlDevice',
    getParams: (device, setting) => ({ id: device.deviceNfo.deviceId, mode: setting?.mode || PurMode.AUTO_MODE }),
    supportedDevices: [K2]
  }
};
